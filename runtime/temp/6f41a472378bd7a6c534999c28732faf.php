<?php /*a:2:{s:53:"E:\hj_shop/public/themes/admin/default/goods\add.html";i:1558689784;s:55:"E:\hj_shop/public/themes/admin/default/public\head.html";i:1558677994;}*/ ?>
<!doctype html>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <div onclick="uploadPic('#thumbnail')" class="wrap_img">
                                <img src="http://hj_shop.com/themes/admin/default/public/assets/images/default-thumbnail.png" alt="">
                            </div>
    ...
    <script>
        ...
        function  uploadPic(id) {
            layer.open({
                ...
                area: ['500px', '300px'],
                title:'添加图片',
                content: ['<?php echo url('admin/storage/add'); ?>', 'no'], //这里content是一个URL，如果你不想让iframe出现滚动条，你还可以content: ['http://sentsin.com', 'no']
                btn:['确认','取消'],
                fixed:true,
                resize:false
