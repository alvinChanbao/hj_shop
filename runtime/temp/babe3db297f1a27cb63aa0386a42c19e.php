<?php /*a:2:{s:62:"H:\project\hj_shop/public/themes/admin/default/index\main.html";i:1558674008;s:63:"H:\project\hj_shop/public/themes/admin/default/public\head.html";i:1558831798;}*/ ?>
<!doctype html>
            ...
            <div class="layui-card">
                <div class="layui-card-body ">
                    <blockquote class="layui-elem-quote">欢迎管理员：
                        <span class="x-red"><?php echo htmlentities($adminUser['user_login']); ?></span>！当前时间:2018-04-25 20:50:53
                    </blockquote>
                </div>
            </div>
        </div>
                ...
                <div class="layui-card-body ">
                    <ul class="layui-row layui-col-space10 layui-this x-admin-carousel x-admin-backlog">
                        <li class="layui-col-md2 layui-col-xs6">
                            <a class="x-admin-backlog-body" href="javascript:;">
                                <h3>文章数</h3>
                                <p>
                                    <cite>66</cite></p>
                            </a>
